...
export default class ImageSlider extends HTMLElement {
    ...
    render() {
        this.innerHTML = `
            ...
            <div class="back-btn">
                <a><img src="/images/Icons/arrow-left.svg"/></a>
            </div>
            <div class="next-btn">
              <a><img src="/images/Icons/arrow-right.svg"/></a>
            </div>
            </div>
  ...
  export let images = ['https://images.unsplash.com/photo-1496440543089-3d0eb669f6f6?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=788&q=80',
